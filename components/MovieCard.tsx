    ...
    <Link href={`/movies/${id}`} asChild>
      <TouchableOpacity className="w-[30%]">
        <View className="relative rounded-lg overflow-hidden">
          ...
          {adult && <View className="absolute top-2 left-2/3 flex flex-row items-center justify-start gap-x-1 bg-red-500 p-1 rounded-md mt-0.5 ml-1.5">
            <Text className="text-xs text-white uppercase font-extrabold">
              +18
            </Text>
          </View>}

          {video && <View className="absolute top-3/4 left-2/3 flex flex-row items-center justify-start gap-x-1 bg-red-500 p-1 rounded-md mt-0.5 ml-1.5">
            <Text className="text-xs text-white uppercase font-extrabold">
              vid
            </Text>
          </View>}
